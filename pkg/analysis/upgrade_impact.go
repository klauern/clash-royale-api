	...
	return []DeckArchetypeTemplate{
		{
			...
			SupportCards: []string{"Fireball", "Lightning", "Cannon", "Furnace"},
			MinElixir:    3.0,
			MaxElixir:    4.0,
		},
		{
			...
			SupportCards: []string{"Musketeer", "Ice Spirit", "Skeletons", "Cannon"},
			MinElixir:    2.6,
			MaxElixir:    3.5,
		},
		{
			Name:         "Giant Beatdown",
			WinCondition: "Giant",
			SupportCards: []string{"Witch", "Musketeer", "Prince", "Mega Minion"},
			MinElixir:    3.5,
			MaxElixir:    4.5,
		},
		{
			...
			SupportCards: []string{"Battle Ram", "Royal Ghost", "Electro Wizard"},
			MinElixir:    3.5,
			MaxElixir:    4.5,
		},
		{
			...
			SupportCards: []string{"Princess", "Goblin Gang", "Knight", "Rocket"},
			MinElixir:    2.8,
			MaxElixir:    3.5,
		},
		{
			Name:         "Mortar Siege",
			WinCondition: "Mortar",
			SupportCards: []string{"Knight", "Archers", "Rocket", "Tornado"},
			MinElixir:    2.8,
			MaxElixir:    3.5,
		},
		{
			Name:         "X-Bow Siege",
			WinCondition: "X-Bow",
			SupportCards: []string{"Tesla", "Archers", "Ice Spirit", "Fireball"},
			MinElixir:    3.0,
			MaxElixir:    4.0,
		},
		{
			Name:         "Royal Hogs Split",
			WinCondition: "Royal Hogs",
			SupportCards: []string{"Flying Machine", "Earthquake", "Fireball"},
			MinElixir:    3.0,
			MaxElixir:    4.0,
		},
	}
...
func (a *UpgradeImpactAnalyzer) inferRole(cardName string) string {
	winConditions := []string{"Royal Giant", "Hog Rider", "Giant", "P.E.K.K.A", "Giant Skeleton",
