...
func TestEvaluateWithRealDecks(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			deckCards: []deck.CardCandidate{
				{Name: "Golem", Elixir: 8, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleWinCondition)},
				{Name: "Night Witch", Elixir: 4, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleSupport)},
				{Name: "Baby Dragon", Elixir: 4, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSupport)},
				{Name: "Lumberjack", Elixir: 4, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleSupport)},
				{Name: "Tornado", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSpellSmall)},
				{Name: "Lightning", Elixir: 6, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSpellBig)},
				{Name: "Mega Minion", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSupport)},
		...
		},
		{
			...
			deckCards: []deck.CardCandidate{
				{Name: "Goblin Barrel", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleWinCondition)},
				{Name: "Princess", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleSupport)},
				{Name: "Goblin Gang", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleCycle)},
				{Name: "Knight", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleCycle)},
				{Name: "Ice Spirit", Elixir: 1, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleCycle)},
				{Name: "Inferno Tower", Elixir: 5, Level: 11, MaxLevel: 14, Rarity: "Rare", Role: new(deck.RoleBuilding)},
				{Name: "Rocket", Elixir: 6, Level: 11, MaxLevel: 14, Rarity: "Rare", Role: new(deck.RoleSpellBig)},
				{Name: "The Log", Elixir: 2, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleSpellSmall)},
			},
		...
		},
		{
			...
			deckCards: []deck.CardCandidate{
				{Name: "X-Bow", Elixir: 6, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleWinCondition)},
				{Name: "Tesla", Elixir: 4, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleBuilding)},
				{Name: "Archers", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleSupport)},
				{Name: "Knight", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleCycle)},
				{Name: "Skeletons", Elixir: 1, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleCycle)},
				{Name: "Ice Golem", Elixir: 2, Level: 11, MaxLevel: 14, Rarity: "Rare", Role: new(deck.RoleCycle)},
				{Name: "Fireball", Elixir: 4, Level: 11, MaxLevel: 14, Rarity: "Rare", Role: new(deck.RoleSpellBig)},
		...
		},
		{
			...
			deckCards: []deck.CardCandidate{
				{Name: "P.E.K.K.A", Elixir: 7, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleWinCondition)},
				{Name: "Battle Ram", Elixir: 4, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleWinCondition)},
				{Name: "Bandit", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleSupport)},
				{Name: "Royal Ghost", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleSupport)},
				{Name: "Electro Wizard", Elixir: 4, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleSupport)},
				{Name: "Minions", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleSupport)},
				{Name: "Poison", Elixir: 4, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSpellBig)},
				{Name: "Zap", Elixir: 2, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleSpellSmall)},
			},
		...
		},
		{
			...
			deckCards: []deck.CardCandidate{
				{Name: "Graveyard", Elixir: 5, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleWinCondition)},
				{Name: "Frozen Mirror", Elixir: 2, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSpellSmall)},
				{Name: "Lava Hound", Elixir: 7, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleWinCondition)},
				{Name: "Ice Wizard", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleSupport)},
				{Name: "Skeleton Army", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSupport)},
				{Name: "Tombstone", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Rare", Role: new(deck.RoleBuilding)},
				{Name: "Poison", Elixir: 4, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSpellBig)},
				{Name: "The Log", Elixir: 2, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleSpellSmall)},
			},
		...
		},
		{
			...
			deckCards: []deck.CardCandidate{
				{Name: "Balloon", Elixir: 5, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleWinCondition)},
				{Name: "Frozen Mirror", Elixir: 2, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSpellSmall)},
				{Name: "Hog Rider", Elixir: 4, Level: 11, MaxLevel: 14, Rarity: "Rare", Role: new(deck.RoleWinCondition)},
				{Name: "Ice Wizard", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleSupport)},
				{Name: "Musketeer", Elixir: 4, Level: 11, MaxLevel: 14, Rarity: "Rare", Role: new(deck.RoleSupport)},
		...
		},
		{
			...
			deckCards: []deck.CardCandidate{
				...
				{Name: "Mega Minion", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSupport)},
				{Name: "Minions", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleSupport)},
				{Name: "Skeleton Dragons", Elixir: 4, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSupport)},
				{Name: "Tornado", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSpellSmall)},
				{Name: "Lightning", Elixir: 6, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSpellBig)},
				{Name: "Ice Spirit", Elixir: 1, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleCycle)},
			},
		...
		},
		{
			name: "Miner Control",
			deckCards: []deck.CardCandidate{
				{Name: "Miner", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleWinCondition)},
				{Name: "Rocket", Elixir: 6, Level: 11, MaxLevel: 14, Rarity: "Rare", Role: new(deck.RoleSpellBig)},
				{Name: "Zap", Elixir: 2, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleSpellSmall)},
				{Name: "Ice Wizard", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleSupport)},
				{Name: "Skeleton Army", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSupport)},
				{Name: "Guardians", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSupport)},
				{Name: "Inferno Tower", Elixir: 5, Level: 11, MaxLevel: 14, Rarity: "Rare", Role: new(deck.RoleBuilding)},
				{Name: "The Log", Elixir: 2, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleSpellSmall)},
			},
		...
		},
		{
			...
			deckCards: []deck.CardCandidate{
				{Name: "Golem", Elixir: 8, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleWinCondition)},
				{Name: "Graveyard", Elixir: 5, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleWinCondition)},
				{Name: "Witch", Elixir: 5, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSupport)},
				{Name: "Lumberjack", Elixir: 4, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleSupport)},
				{Name: "Electro Wizard", Elixir: 4, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleSupport)},
				{Name: "Tornado", Elixir: 3, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSpellSmall)},
				{Name: "Poison", Elixir: 4, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSpellBig)},
	...
	tests := []struct {
		...
		},
		{
			...
			deckCards: []deck.CardCandidate{
				{Name: "Skeletons", Elixir: 1, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleCycle)},
				{Name: "Ice Spirit", Elixir: 1, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleCycle)},
				{Name: "Spear Goblins", Elixir: 2, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleCycle)},
				{Name: "The Log", Elixir: 2, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleSpellSmall)},
				{Name: "Zap", Elixir: 2, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleSpellSmall)},
				{Name: "Bats", Elixir: 2, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleCycle)},
				{Name: "Snow Elves", Elixir: 2, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleCycle)},
				{Name: "Goblins", Elixir: 2, Level: 11, MaxLevel: 14, Rarity: "Common", Role: new(deck.RoleCycle)},
			},
			expectValid: true,
		},
		{
			...
			deckCards: []deck.CardCandidate{
				{Name: "P.E.K.K.A", Elixir: 7, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleWinCondition)},
				{Name: "Mega Knight", Elixir: 7, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleWinCondition)},
				{Name: "Electro Giant", Elixir: 8, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleWinCondition)},
				{Name: "Lava Hound", Elixir: 7, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleWinCondition)},
				{Name: "Golem", Elixir: 8, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleWinCondition)},
				{Name: "Rocket", Elixir: 6, Level: 11, MaxLevel: 14, Rarity: "Rare", Role: new(deck.RoleSpellBig)},
				{Name: "Lightning", Elixir: 6, Level: 11, MaxLevel: 14, Rarity: "Epic", Role: new(deck.RoleSpellBig)},
				{Name: "Phoenix", Elixir: 4, Level: 11, MaxLevel: 14, Rarity: "Legendary", Role: new(deck.RoleWinCondition)},
			},
			expectValid: true,
		},
	}
