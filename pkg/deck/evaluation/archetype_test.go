	...
	tests := []struct {
		...
		},
		{
			...
			deckCards: []deck.CardCandidate{
				...
				{Name: "Cannon", Elixir: 3, Role: new(deck.RoleBuilding)},
		...
		},
		{
			...
			deckCards: []deck.CardCandidate{
				{Name: "X-Bow", Elixir: 6},
				{Name: "Tesla", Elixir: 4, Role: new(deck.RoleBuilding)},
		...
		},
		{
			...
			deckCards: []deck.CardCandidate{
				...
				{Name: "Knight", Elixir: 3},
				{Name: "Ice Spirit", Elixir: 1},
				{Name: "Inferno Tower", Elixir: 5, Role: new(deck.RoleBuilding)},
		...
		},
		{
			...
			deckCards: []deck.CardCandidate{
				...
				{Name: "Baby Dragon", Elixir: 4},
				{Name: "Bomb Tower", Elixir: 4, Role: new(deck.RoleBuilding)},
	...
	labeledDecks := []labeledDeck{
		...
		// === ADDITIONAL BEATDOWN VARIANTS (Adding diversity) ===
		{
			...
			DeckCards: []deck.CardCandidate{
				...
				{Name: "Mega Minion", Elixir: 3},
				{Name: "Baby Dragon", Elixir: 4},
				{Name: "Tombstone", Elixir: 3, Role: new(deck.RoleBuilding)},
				{Name: "Poison", Elixir: 4},
				{Name: "Zap", Elixir: 2},
				{Name: "Skeletons", Elixir: 1},
			},
